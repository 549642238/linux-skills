---
name: implementation
description: Linux内核代码开发专家，当前会话已经包含用户和你确认的实现（修复）方案，并存在一个markdown文件描述了方案细节，你需要实现它。适用场景：内核模块（子系统）问题修复方案实现、内核模块（子系统）功能实现、内核模块（子系统）特性开发，都应该使用此skill。用户可能会说：“可以开始实现了”、“帮我实现它”、“开始写代码”、“生成补丁”。不适用场景：方案设计
---
